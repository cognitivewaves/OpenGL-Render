...
PFNGLDISABLEVERTEXATTRIBARRAYPROC glDisableVertexArrayAttrib = NULL;
...
void LoadGLExtensions()
{
    ...
    glDisableVertexArrayAttrib = (PFNGLDISABLEVERTEXATTRIBARRAYPROC) wglGetProcAddress("glDisableVertexArrayAttrib");
